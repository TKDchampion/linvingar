<p>新增成功
    <input type="button" onclick="javascript:location.href='http://www.linvinegar.com/'" value="確認"></input>
    <input type="button" onclick="javascript:location.href='http://www.linvinegar.com/cancel.php'" value="取消"></input>
</p>
<?php
 $dbhost = 'localhost';
